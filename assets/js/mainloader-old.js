...
document.addEventListener("DOMContentLoaded", function () {
	const videos = document.querySelectorAll("video"); videos.forEach(function (video) {
...
/*function setup_thought_of_the_day() {
	window.addEventListener("DOMContentLoaded", function () {
		// quote-of-the-day
		const quotes = [
			'"To err is human, to forgive is design." â€“ Andrew Dillon',
...
/*function setup_posthog() {
	...
	posthog.init('phc_zTPkxUE6DsTVNIZem5onI6EHRPu235yo1RFFZLBgvMH', {
		api_host: 'https://onboarding.frappe.cloud', person_profiles: 'identified_only' // or 'always' to create profiles for anonymous users as well
	})
